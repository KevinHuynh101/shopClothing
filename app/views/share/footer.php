    ...
    <!-- Page level plugins -->
    <script src="/shopclothing/public/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/shopclothing/public/js/demo/chart-area-demo.js"></script>
    <script src="/shopclothing/public/js/demo/chart-pie-demo.js"></script>
